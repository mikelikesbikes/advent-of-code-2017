...
group_tests = [
  ...
  pass = count == group.count && score = group.score
  puts "#{input}: #{pass ? :pass : :fail }"
end
...
garbage_tests = [
  ...
  chars = input.chars
  garbage = parse_garbage(chars)
  pass = chars.empty? && garbage.text.length == count
  puts "#{input}: #{pass ? :pass : :fail }"
end
...
stream_tests = [
  ...
  pass = count == stream.count && score = stream.score
  puts "#{input}: #{pass ? :pass : :fail }"
end
